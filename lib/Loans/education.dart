...
class educationalLoan extends StatefulWidget {
  const educationalLoan({super.key});

  @override
  State<educationalLoan> createState() => _educationalLoanState();
}

class _educationalLoanState extends State<educationalLoan> {
  @override
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          'Interest rate of 7-8% for 15 years.',
                          style: TextStyle(
                              color: Color.fromARGB(255, 0, 183, 255),
                              fontSize: 15),
                        ),
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          child: IconButton(
                              color: Colors.black,
                              onPressed: () {
                                Navigator.pushNamed(context, 'education1');
                              },
                              icon: Icon(
                                Icons.arrow_forward,
                              )),
